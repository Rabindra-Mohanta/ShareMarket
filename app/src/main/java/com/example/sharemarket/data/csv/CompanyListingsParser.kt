package com.example.sharemarket.data.csv
    ...
    override suspend fun parse(stream: InputStream): List<CompanyListing> {
        ...
        return withContext(Dispatchers.IO)
        {
            csvReader.readAll().drop(1).mapNotNull { line->
                ...
                CompanyListing(name = name?:return@mapNotNull null,symbol = symbol?:return@mapNotNull null,exchange = exchange?:return@mapNotNull null)
            }.also {
                csvReader.close()
            }
        }
